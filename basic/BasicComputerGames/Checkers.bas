...
1230 PRINT CHR$(26)"FROM"R(1);R(2)"TO"R(3);R(4);:R(0)=-99
...
1340 X=R(3):Y=R(4)
1345 IF S(X,Y)=-1 THEN B=-2:FOR A=-2 TO 2 STEP 4:GOSUB 1370
1350 IF S(X,Y)<>-2 THEN 1360
...
1400 RETURN
1420 ?:?:?:FOR Y=7 TO 0 STEP-1:FOR X=0 TO 7:I=5*X:? TAB(I);
