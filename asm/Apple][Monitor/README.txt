...
I adapted the orignal monitor source from the "Red Book" to build
...
monitor is $7F65. The Mini-Assembler entry point is $7666.

Known Issues:

I have only tested this code on a Briel Replica 1, but it does match
the binaries posted by Wendell Sander.
