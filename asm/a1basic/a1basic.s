...
error_msg_tbl:	.byte	$be,$b3,$b2,$b7,$b6,$37,$d4,$cf	; ">32767TO"
	.byte	$cf,$a0,$cc,$cf,$ce,$47,$d3,$d9	; "O LONGSY"
	.byte	$ce,$d4,$c1,$58,$cd,$c5,$cd,$a0	; "NTAXMEM "
	.byte	$c6,$d5,$cc,$4c,$d4,$cf,$cf,$a0	; "FULLTOO "
	.byte	$cd,$c1,$ce,$d9,$a0,$d0,$c1,$d2	; "MANY PAR"
	.byte	$c5,$ce,$53,$d3,$d4,$d2,$c9,$ce	; "ENSSTRIN"
	.byte	$47,$ce,$cf,$a0,$c5,$ce,$44,$c2	; "GNO ENDB"
	.byte	$c1,$c4,$a0,$c2,$d2,$c1,$ce,$c3	; "AD BRANC"
	.byte	$48,$be,$b8,$a0,$c7,$cf,$d3,$d5	; "H>8 GOSU"
	.byte	$c2,$53,$c2,$c1,$c4,$a0,$d2,$c5	; "BSBAD RE"
	.byte	$d4,$d5,$d2,$4e,$be,$b8,$a0,$c6	; "TURN>8 F"
	.byte	$cf,$d2,$53,$c2,$c1,$c4,$a0,$ce	; "ORSBAD N"
	.byte	$c5,$d8,$54,$d3,$d4,$cf,$d0,$d0	; "EXTSTOPP"
	.byte	$c5,$c4,$a0,$c1,$d4,$20,$aa,$aa	; "ED AT **"
	.byte	$aa,$20,$a0,$c5,$d2,$d2,$0d,$be	; "*  ERR.>"
	.byte	$b2,$b5,$35,$d2,$c1,$ce,$c7,$45	; "255RANGE"
	.byte	$c4,$c9,$4d,$d3,$d4,$d2,$a0,$cf	; "DIMSTR O"
	.byte	$d6,$c6,$4c,$dc,$0d,$d2,$c5,$d4	; "VFL\.RET"
	.byte	$d9,$d0,$c5,$a0,$cc,$c9,$ce,$c5	; "YPE LINE"
	.byte	$8d,$3f                  	; ".?"
Leb9a:	LSR	run_flag
	BCC	Leba1
	JMP	Le8c3
